<div class="container px-6 mx-auto grid">
    <h1 class="my-6">Work Experiences</h1>
    ...
    <div class="grid gap-6 md:grid-cols-2 mb-6">
        ...
        <div>
            <h4 class="mb-4 ">Manage Work Experiences</h4>

            <form @if ($isStore) wire:submit.prevent="storeWE" @else wire:submit.prevent="updateWE" @endif class="card">
                <div class="card-body">
    ...
    <div class="table-wrapper">
                            ...
                            <td>
                                <div class="flex items-center space-x-4 text-sm">
                                    <button
                                        ...
                                        aria-label="Edit" wire:click.prevent="showWE({{ $workExperience->id }})">
                                    ...
                                    <button
                                        class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-primary-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                        aria-label="Delete" wire:click.prevent="destroyWE({{ $workExperience->id }})">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
        ...
        {{ $workExperiences->links('components.pagination-links') }}
    </div>
</div>
